...
const QUALITY_TYPES = {
    ...
    numeric_odds: {
        ...
        minValue: 0,
        maxValue: 3,
        defaultFailThreshold: 2.5,
        defaultMinorThreshold: 3.5,
    },
    percentage: {
            ...
            <ResponsiveContainer width="100%" height={300}>
                {chartConfig.type === 'pie' || chartConfig.type === 'donut' ? (
                    <PieChart>
                        ...
                        <Tooltip contentStyle={{ background: '#1e293b', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '8px', color: '#fff' }} formatter={tooltipFormatter} />
                    </PieChart>
...
function SetupWizard({ columns, sampleData, rawData = [], onComplete, onCancel }) {
    ...
    const [config, setConfig] = useState({
        ...
        // Numeric thresholds
        numericFailThreshold: [0, 1, 2, 3, 4, 5],   // Below this = fail
        numericMinorThreshold: [0, 1, 2, 3, 4, 5],  // Below this (but >= fail threshold) = minor
...
export default function QADashboardGenerator() {
    ...
    const processedData = useMemo(() => {
        ...
        return rawData.map(row => {
            ...
            // Does the user have explicit discrete pass/fail/minor selections?
            const hasDiscreteMapping =
