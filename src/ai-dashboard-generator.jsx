    ...
    const handleQualityTypeSelect = (type) => {
        ...
        if (qualityConfig) {
            if (qualityConfig.isNumeric) {
                ...
                updateConfig('minorValues', qualityConfig.defaultMinor || []);
                updateConfig('failValues', qualityConfig.defaultFail || []);
            }
        }
    };
                                    ...
                                    <div className="p-5 bg-rose-500/10 border-2 border-rose-500/30 rounded-xl">
                                        ...
                                        <div className="relative">
                                            <input
                                                ...
                                                onChange={(e) => updateConfig('numericFailThreshold', parseFloat(e.target.value) || qualityConfig.defaultFailThreshold)}
                                    ...
                                    <div className="p-5 bg-amber-500/10 border-2 border-amber-500/30 rounded-xl">
                                        ...
                                        <div className="relative">
                                            <input
                                                ...
                                                onChange={(e) => updateConfig('numericMinorThreshold', parseFloat(e.target.value) || qualityConfig.defaultMinorThreshold)}
